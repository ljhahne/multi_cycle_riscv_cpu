...
@pytest.mark.parametrize(
    "a,b", [(0b11111111111111111111111111111111, 0b1), (0b01111111111111111111111111111111, 0b1)]
)
def test_C(a, b, op):
...
@pytest.mark.parametrize(
    "a", [0b11111111111111111111111111111111, 0b1]
)
@pytest.mark.parametrize(
    "b", [0b11111111111111111111111111111111, 0b1]
)
def test_V(a, b, op):
...
@pytest.mark.parametrize(
    "a, b", [(0b01111111111111111111111111111111, 0b1), (0b01111111111111111111111111111110, 0b1)]
)
def test_N(a, b, op):
    run_simulation(config, "test_aluflags_N", waveform_file, set_signals(a, b, op))

@pytest.mark.parametrize(
    "a, b", [(0b1, 0b1), (0b1, 0b10), (0b10, 0b1)]
)
def test_Z(a, b):
    run_simulation(config, "test_aluflags_Z", waveform_file, set_signals(a, b, ALUControl.SUB))